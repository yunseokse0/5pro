...
export default function ROICalculator() {
  ...
  return (
    <section className="px-6 md:px-12 py-16 bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-gray-800 dark:to-gray-900">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
            언제 수익 전환이 가능할까?<br />
            <span className="text-indigo-600 dark:text-indigo-400">오프로로 투자 회수 속도를 확인하세요</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          {/* 입력 패널 */}
          <div className="p-8 rounded-2xl border bg-white dark:bg-gray-800 shadow-lg border-gray-200 dark:border-gray-700">
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">투자 회수 시뮬레이터</h3>
...
function FieldMoney({
  ...
  return (
    <label className="block">
      ...
      <input
        inputMode="numeric"
        className="mt-1 w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
  ...
  return (
    <label className="block">
      <div className="flex items-center justify-between">
        <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{label}</span>
        <span className="text-sm text-indigo-600 dark:text-indigo-400 font-semibold">{(value * 100).toFixed(0)}%</span>
      </div>
      <input
        type="range"
        min={min}
        ...
        className="mt-2 w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-lg appearance-none cursor-pointer slider"
        style={{
