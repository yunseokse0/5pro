    ...
    <section className="px-6 md:px-12 py-20 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
          ...
          <span className="text-indigo-600">설계부터 검증까지 함께합니다</span>
        </h1>
        <p className="mt-6 text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
          <span className="font-semibold text-gray-800">HACCP 검증부터 실시간 품질관리까지</span>, 
          모든 과정을 사진과 데이터로 투명하게 관리합니다. 
          <br className="hidden md:block" />
          <span className="text-indigo-600 font-semibold">AI 견적으로 공사비 20% 절감</span>, 
          <span className="text-purple-600 font-semibold">스마트팩토리로 운영비 15% 절감</span>을 동시에 실현합니다.
        </p>
        <div className="mt-8 mb-8">
          <div className="inline-flex items-center space-x-8 bg-white/80 backdrop-blur-sm rounded-2xl px-8 py-6 shadow-lg border border-gray-100">
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-indigo-600">200+</div>
              <div className="text-sm text-gray-600">완공 사례</div>
            </div>
            <div className="w-px h-12 bg-gray-200"></div>
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-green-600">20년</div>
              <div className="text-sm text-gray-600">전문가 경력</div>
            </div>
            <div className="w-px h-12 bg-gray-200"></div>
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-purple-600">95%</div>
              <div className="text-sm text-gray-600">HACCP 인증 성공률</div>
            </div>
          </div>
        </div>
        <div className="mt-8">
