      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <div className="mt-6 flex gap-3">
            <a href="/3d-visualization" className="px-5 py-3 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700">절감 효과 계산하기</a>
            <a href="/smart-factory" className="px-5 py-3 rounded-lg border hover:bg-white">효율 시뮬레이터 실행</a>
          </div>
        </div>
