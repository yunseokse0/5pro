          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg">
            ...
            <div className="bg-gray-50 rounded-xl p-4 mb-4">
              <div className="text-center mb-3">
                <span className="text-sm font-semibold text-gray-700">위생 동선 시각화</span>
              </div>
              <div className="relative bg-white rounded-lg h-48 border-2 border-gray-200">
                {/* 원료 입고 */}
                <div className="absolute top-2 left-2 w-12 h-8 bg-green-100 border border-green-300 rounded flex items-center justify-center">
                  <span className="text-xs font-medium text-green-700">입고</span>
                </div>
                {/* 전처리 */}
                <div className="absolute top-12 left-8 w-16 h-10 bg-blue-100 border border-blue-300 rounded flex items-center justify-center">
                  <span className="text-xs font-medium text-blue-700">전처리</span>
                </div>
                {/* 가공 */}
                <div className="absolute top-12 right-8 w-16 h-10 bg-purple-100 border border-purple-300 rounded flex items-center justify-center">
                  <span className="text-xs font-medium text-purple-700">가공</span>
                </div>
                {/* 포장 */}
                <div className="absolute bottom-12 right-8 w-16 h-10 bg-orange-100 border border-orange-300 rounded flex items-center justify-center">
                  <span className="text-xs font-medium text-orange-700">포장</span>
                </div>
                {/* 출고 */}
                <div className="absolute bottom-2 right-2 w-12 h-8 bg-red-100 border border-red-300 rounded flex items-center justify-center">
                  <span className="text-xs font-medium text-red-700">출고</span>
                </div>
                
                {/* 화살표 */}
                <div className="absolute top-6 left-14 w-8 h-0.5 bg-gray-400"></div>
                <div className="absolute top-17 left-20 w-0.5 h-8 bg-gray-400"></div>
                <div className="absolute top-17 right-24 w-0.5 h-8 bg-gray-400"></div>
                <div className="absolute bottom-17 right-24 w-8 h-0.5 bg-gray-400"></div>
              </div>
              <div className="text-xs text-gray-600 mt-2 text-center">
                원료 → 전처리 → 가공 → 포장 → 출고 (단방향 흐름)
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-emerald-50 rounded-lg p-3 text-center">
                ...
                <div className="text-xs text-gray-600">HACCP 준수</div>
              </div>
              <div className="bg-blue-50 rounded-lg p-3 text-center">
                <div className="text-lg font-bold text-blue-600">24시간</div>
                <div className="text-xs text-gray-600">위생 모니터링</div>
              </div>
            </div>
          </div>
