      ...
      <div className="mt-12 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-6 md:p-10 border border-blue-100">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg">
            ...
            {/* 위생 동선 시각화 */}
            <div className="bg-gradient-to-br from-slate-50 to-blue-50 rounded-xl p-6 mb-6 shadow-inner">
              <div className="text-center mb-4">
                <h6 className="text-base font-bold text-gray-800 flex items-center justify-center gap-2">
              ...
              <div className="relative bg-white rounded-2xl h-64 border border-gray-200 shadow-lg overflow-hidden">
                {/* 배경 그라데이션 */}
                ...
                <div className="relative z-10 h-full">
                  ...
                  <div className="absolute top-4 left-4 group">
                    <div className="bg-gradient-to-br from-emerald-400 to-emerald-600 rounded-xl w-16 h-12 shadow-lg flex items-center justify-center transform transition-all duration-300 hover:scale-110 hover:shadow-xl">
                      <div className="text-center">
                        <Truck className="w-4 h-4 text-white mx-auto mb-1" />
                        <span className="text-xs font-bold text-white">입고</span>
                      </div>
                    </div>
                  ...
                  <div className="absolute top-16 left-20 group">
                    <div className="bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl w-18 h-14 shadow-lg flex items-center justify-center transform transition-all duration-300 hover:scale-110 hover:shadow-xl">
                      <div className="text-center">
                        <Settings className="w-5 h-5 text-white mx-auto mb-1" />
                        <span className="text-xs font-bold text-white">전처리</span>
                      </div>
                    </div>
                    <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2">
                  ...
                  <div className="absolute top-16 right-20 group">
                    <div className="bg-gradient-to-br from-purple-400 to-purple-600 rounded-xl w-18 h-14 shadow-lg flex items-center justify-center transform transition-all duration-300 hover:scale-110 hover:shadow-xl">
                      <div className="text-center">
                        <Factory className="w-5 h-5 text-white mx-auto mb-1" />
                        <span className="text-xs font-bold text-white">가공</span>
                      </div>
                    </div>
                    <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2">
                  ...
                  {/* 포장 */}
                  <div className="absolute bottom-16 right-20 group">
                    <div className="bg-gradient-to-br from-orange-400 to-orange-600 rounded-xl w-18 h-14 shadow-lg flex items-center justify-center transform transition-all duration-300 hover:scale-110 hover:shadow-xl">
                      <div className="text-center">
                        <Package className="w-5 h-5 text-white mx-auto mb-1" />
                        <span className="text-xs font-bold text-white">포장</span>
                      </div>
                    </div>
                    <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2">
                  ...
                  <div className="absolute bottom-4 right-4 group">
                    <div className="bg-gradient-to-br from-red-400 to-red-600 rounded-xl w-16 h-12 shadow-lg flex items-center justify-center transform transition-all duration-300 hover:scale-110 hover:shadow-xl">
                      <div className="text-center">
                        <Truck className="w-4 h-4 text-white mx-auto mb-1" />
                        <span className="text-xs font-bold text-white">출고</span>
                      </div>
                    </div>
                    <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2">
              ...
              <div className="text-center mt-4">
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-100 to-blue-100 rounded-full px-4 py-2">
